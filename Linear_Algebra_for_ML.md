...
<a name="MatrixInverse">  
 ...
 -	### Matrix Inverse _(Обратная матрица, обратное преобразование)_
    ...
    It is straightforward how to solve x*c = y if we are dealing with scalars. If we are solving for x, we just multiply y by the inverse of c, whch is 1/c. The same solving principle applies solving equation with matricies and vectors, but how does the matrix inverse look like?  
