...
<a name="MatrixInverse">  
 ...
 -	### Matrix Inverse _(Обратная матрица, обратное преобразование)_
    ...
    It is straightforward how to solve x*c = y if we are dealing with scalars. If we are solving for x, we just devide y by c. But the same equation solving principle does not apply for equations with matricies.  
